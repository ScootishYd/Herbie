...
<body class="bg-gray-50 min-h-screen font-roboto">
    ...
    <form action="{{ route('login.submit') }}" method="post" class="flex items-center justify-center min-h-[80vh]">
        @csrf
        <div class="bg-white p-8 rounded-lg shadow-md w-[400px]">
            ...
            <div class="mb-4">
                <label for="email" class="block text-green-800 text-sm font-medium mb-1">Masukkan E-mail</label>
